...
function BrowserCheckout({ skill }: { skill: Skill }) {
  ...
  const description = owned
    ...
    : `Pay $${skill.priceUsdc} USDC from your connected wallet. The payment is sent to SkillsBay and your access entitlement is recorded automatically.`
